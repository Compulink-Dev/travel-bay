      ...
      cell: ({ row }) => {
        ...
        return (
          <Button variant="outline" size="sm" asChild>
            <a href={mapUrl(hotel)} target="_blank" rel="noreferrer">
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{editing ? "Edit Hotel" : "New Hotel"}</DialogTitle>
            </DialogHeader>
      ...
      {loading ? (
        ...
        <DataTable
          ...
          data={items}
          searchKey="name"
          searchPlaceholder="Filter hotels..."
        />
      )}
    </div>
  );
